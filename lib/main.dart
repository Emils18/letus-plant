...
Future<void> main() async {
  ...
  // Start listening immediately for GreenGuard ESP32-CAM.
  //
  // This means:
  // Open app → turn hotspot on → power ESP32-CAM
  // → ESP32 announces itself → app remembers its IP.
  await EspCamService().startDiscoveryServer();
...
class _MobileRoleBlockedScreen
